...
def evaluate_dice_score(pred_mask_path, gt_mask_path, output_file):
    """
    ...
    for pred_img_name, gt_img_name in matched_files:
        ...
        dice_scores.append((pred_img_name, dice.item()))

        # Save Dice scores to a text file
        with open(output_file, "w") as file:
            for row_number, score in dice_scores:
                file.write(f"{row_number}: {score:.4f}\n")
...
if __name__ == "__main__":
    ...
    pred_mask_path = '/home/zhangyanyu/unet/data/test09/predict'
    gt_mask_path = '/home/zhangyanyu/unet/data/test09/masks/0'
    output_txt_path = '/home/zhangyanyu/unet/data/test09/predict_dice'

    avg_dice = evaluate_dice_score(pred_mask_path, gt_mask_path, output_txt_path)
